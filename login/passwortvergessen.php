                ...
                if (isset($_GET['send'])) {
                    if (!isset($_POST['email']) || empty($_POST['email'])) {
                        ...
                        if ($user === false) {
                            ...
                            $url_passwortcode = 'http://vokabeln.local/login/passwortvergessen.php?userid=' . $user['id'] . '&code=' . $passwortcode; //Setzt hier eure richtige Domain ein
...
dein PHP-Einfach.de-Team';
                ...
                if ($showForm):
                    ...
                    <form action="?send=1" method="post">
                        ...
                        <input type="submit" value="Neues Passwort" class="btn btn-primary" style="margin-top:25px;">
                    </form>
