...
$stmt = $pdo->prepare("INSERT INTO Vokabeln (Sprachen_Id,Deutsch,Fremdsprache) VALUES (?,?,?)");
# Statement ausführen
//$stmt->execute(array($_POST['languageId'],$_POST['deutschWord'],$_POST['fremdspracheWord'],$_POST['ausspracheWord']));
$stmt->execute(array(ucfirst($_POST['languageId']),ucfirst($_POST['deutschWord']),ucfirst($_POST['fremdspracheWord'])));
?>